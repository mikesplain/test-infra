...
func getPRHistory(url *url.URL, config *config.Config, opener prowio.Opener, gitHubClient deckGitHubClient, gitClient *git.Client, gitEndpoint string) (prHistoryTemplate, error) {
	start := time.Now()
